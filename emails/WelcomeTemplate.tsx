...
//       {/* <Body style={{background: "#fff"}}> */} // This is using inline styles
//       {/* <Body style={body}> */}
//       <Tailwind>
//         <Body className="bg-white">
//           // Using tailwind css // This is using CSS Properties
//           <Container>
//             {/* <Text style={heading}>Hello {name}</Text> // This is using CSS */}
//             <Text className="font-bold text-3xl">Hello {name}</Text>
//             Properties
//             <Link href="www.chaitanyaasole@gmail.com">
//               www.chaitanyaasole@gmail.com
//             </Link>
//           </Container>
//         </Body>
//       </Tailwind>
